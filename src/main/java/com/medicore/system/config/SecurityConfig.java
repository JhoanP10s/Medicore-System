    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/disponibilidad-medica/**").hasAnyRole("ADMIN", "DOCTOR")
                        .requestMatchers("/disponibilidad-medica/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/bloqueo-agenda/**").hasAnyRole("ADMIN", "DOCTOR")
                        .requestMatchers("/bloqueo-agenda/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/dashboard/**").hasAnyRole("ADMIN", "DOCTOR", "USER")
                        .requestMatchers("/agenda/**").hasAnyRole("ADMIN", "DOCTOR")
                        .requestMatchers("/historia-clinica/**").hasAnyRole("ADMIN", "DOCTOR")
